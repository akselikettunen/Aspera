  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg px-6">
      <div className="w-full max-w-md border border-line bg-surface rounded-[3px] p-8">
        ...
        <h1 className="text-2xl font-bold tracking-[-0.02em] text-text mb-1">Create an account</h1>
        <p className="text-sub mb-6 text-sm">Start training for math competitions</p>
